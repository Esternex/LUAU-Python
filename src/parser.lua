  20:44:12.749  SOURCE|local module = {}
...
functi  -  Edit
  20:44:12.749  SOURCE|on module:parse_global_statement()
	self:eat()
...
function module:parse_try_statement()
  ...
  20:44:12.749  SOURCE|cType = excType, name = name, body = handlerBody })
	end
...
function module:ProduceAST(sourceCode)
	...
	while (self:not_eof()) do
		...
		elseif self:at()[2] == "Dedent" then
			...
			local stmt = self:parse_stmt()
			if stmt and stm  -  Edit
  20:44:12.749  SOURCE|t.kind then
